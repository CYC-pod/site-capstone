...
export default function ResGrid() {
  ...
  useEffect(() => {
    async function getRes() { //gets all restaurants that meet one or more of the users requirements 
  ...
  return (
    ...
    >
      ...
      <FormControl sx={{ m: 1, width: 300 }}>
        <InputLabel id="demo-multiple-checkbox-label"> Dietary Options</InputLabel>
        <Select
      ...
      {restaurants.filter(restaurant => checker(restaurant.restriction_name, selected)).map((rest, index) => {
        return (
